...
const AddTurnAdmin = () => {
    ...
    fetch(urlTurnId, {
      ...
      .then((data) => {
        ...
        setEspecilistaFiltrado(
          odontologos.filter((item) => data.especialidad === item.especialidad)
        );
        setSelectedDoctor(data.odontologoId);

        const urlTurnsOdontology =
          baseUrl.url + "/turnos/turnoOdontologo/" + data.odontologoId;
        const urlTurnsPatients =
          baseUrl.url + "/turnos/turnosPaciente/" + data.pacienteId;
  ...
  useEffect(() => {
    const turnosFiltradosOdontologo = turnsOdontology.filter(
      (turno) => turno.fecha === turnoEncontrado.fecha
    );
  ...
  const handleInputChangeDocument = (selectedOption) => {
    ...
    const urlTurnsPatients =
      baseUrl.url + "/turnos/turnosPaciente/" + selectedOption.value;
    fetch(urlTurnsPatients, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
            ...
            <div className="dropdown-edit">
              ...
              <Select
                value={{
                  ...
                  label: formData?.documento,
                }}
                onChange={(selectedOption) =>
                  handleInputChangeDocument(selectedOption)
                }
                isSearchable={false}
