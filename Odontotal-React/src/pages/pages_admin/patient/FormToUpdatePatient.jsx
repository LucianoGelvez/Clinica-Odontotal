...
const FormToUpdatePatient =({ data, onGuardar, onCancelar, informacionCompleta, jwt  }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='main_update__form'>
      ...
      <div className='form-group'>
      <label htmlFor='documento'> Documento: <input type="text"
      ...
      <label htmlFor='telefono'>
        Telefono personal: <input type="number"
